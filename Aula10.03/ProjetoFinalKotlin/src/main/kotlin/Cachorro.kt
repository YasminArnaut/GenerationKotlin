class Cachorro(nome: String,
    ...
    val listaCachorro = mutableListOf<String>("V8: previnem: cinomose, parvovirose, hepatite infecciosa canina," +
    ...
    override fun obrig() {
        if (idade in 0..1){
            ...
            if(idade in 2..3){
                ...
                listaCachorro.add("Antirrábica: obrigatória no território nacional," +
